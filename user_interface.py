...
class user_interface:
    def __init__(self,test_rate=10):
        ...
        self.LPS35HW.setDataRate(self.LPS35HW.LPS35HW_RATE_50_HZ)
...
class csv_writer:
    ...
    def analyze_data(self):
        ...
        fig_vacuum.savefig(os.path.join(self.USB_folder,self.test_folder,self.test_str + '_Pressure.svg'),bbox_inches="tight")
        fig_vacuum.savefig(os.path.join(self.USB_folder,self.test_folder,self.test_str + '_Pressure.pdf'),bbox_inches="tight")
        fig_vacuum.savefig(os.path.join(self.USB_folder,self.test_folder,self.test_str + '_Pressure.png'),bbox_inches="tight",dpi=300)
